...
namespace FoodDelivery.Migrations
{
    ...
    [Migration("20240510024232_EditMealReviewIndex")]
    partial class EditMealReviewIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.CartItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.CartItemOption", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid>("MealSideDishID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("MealSideDishOptionID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("SideDishSizeOption")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("MealSideDishID");

                    b.HasIndex("CartItemID", "MealSideDishID")
                        .IsUnique();

                    b.HasIndex("MealSideDishOptionID", "SideDishSizeOption");

                    b.ToTable("CartItemOption");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.ChiefIngredient", b =>
                {
                    b.Property<string>("ChiefID")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("FoodIngredient")
                        .HasColumnType("int");

                    b.Property<int>("CostPerKilo")
                        .HasColumnType("int");

                    b.Property<bool>("Visible")
                        .HasColumnType("bit");

                    b.HasKey("ChiefID", "FoodIngredient");

                    b.ToTable("ChiefIngredients");
                });
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealOption", b =>
                {
                    ...
                    b.Property<string>("FullScreenImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealOptionIngredient", b =>
                {
                    b.Property<int>("FoodIngredient")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FoodIngredient", "ChiefID", "MealOptionID");

                    b.HasIndex("MealOptionID");

                    b.HasIndex("ChiefID", "FoodIngredient");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealReview", b =>
                {
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("MealID", "CustomerID"), false);

                    b.HasIndex("CustomerID");

                    b.HasIndex("MealID");

                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("MealID"));

                    b.ToTable("MealReviews");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealSideDishOption", b =>
                {
                    ...
                    b.HasKey("SideDishID", "MealSideDishID", "SideDishSizeOption");

                    b.HasIndex("MealSideDishID");

                    b.HasIndex("SideDishID", "SideDishSizeOption");

                    b.ToTable("MealSideDishOption");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.MealSideDish", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MealSideDishes");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.MealTag", b =>
                {
                    b.Property<Guid>("MealID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.SideDish", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.SideDishOption", b =>
                {
                    b.Property<Guid>("SideDishID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SideDishID", "SideDishSizeOption");

                    b.ToTable("SideDishOptions");
                });
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Orders.OrderItemOption", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.SelectedSideDish", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserID", "MealOptionID", "SideDishID");

                    b.HasIndex("SideDishID", "SideDishSizeOption");

                    b.ToTable("SelectedSideDish");
                });
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.WishList", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Chief", b =>
                {
                    ...
                    b.Property<string>("ChiefFullScreenImage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("HealthCertImage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Cart", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.User", "User")
                        .WithOne()
                        .HasForeignKey("FoodDelivery.Models.DominModels.Cart", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.CartItem", b =>
                {
                    ...
                    b.HasOne("FoodDelivery.Models.DominModels.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.CartItemOption", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.CartItem", "CartItem")
                        .WithMany("ItemOptions")
                        .HasForeignKey("CartItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Models.DominModels.Meals.MealSideDish", "MealSideDish")
                        .WithMany()
                        .HasForeignKey("MealSideDishID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Models.DominModels.Meals.SideDishOption", "SideDishOption")
                        .WithMany()
                        .HasForeignKey("MealSideDishOptionID", "SideDishSizeOption")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CartItem");

                    b.Navigation("MealSideDish");

                    b.Navigation("SideDishOption");
                });
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealOptionIngredient", b =>
                {
                    ...
                    b.HasOne("FoodDelivery.Models.DominModels.ChiefIngredient", "ChiefIngredient")
                        .WithMany("MealOptionIngredients")
                        .HasForeignKey("ChiefID", "FoodIngredient")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChiefIngredient");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealSideDishOption", b =>
                {
                    ...
                    b.HasOne("FoodDelivery.Models.DominModels.Meals.SideDishOption", "SideDishOption")
                        .WithMany()
                        .HasForeignKey("SideDishID", "SideDishSizeOption")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.SideDishOption", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.Meals.SideDish", "SideDish")
                        .WithMany("SideDishOptions")
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Orders.OrderItemOption", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.Orders.OrderItem", "OrderItem")
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.MealSideDish", b =>
                {
                    b.Navigation("MealSideDishOptions");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.SideDish", b =>
                {
                    b.Navigation("SideDishOptions");
                });
