...
namespace FoodDelivery.Migrations
{
    ...
    [Migration("20240228172028_EditingImages")]
    partial class EditingImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.FreeSideDish", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("FreeSideDishes");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.FreeSideDishOption", b =>
                {
                    b.Property<Guid>("FreeSideDishID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("MealOptionID")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FreeSideDishID", "MealOptionID");

                    b.HasIndex("MealOptionID");

                    b.ToTable("FreeSideDishOption");
                });
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.FreeSideDish", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.MealOption", null)
                        .WithMany("FreeSideDishes")
                        .HasForeignKey("MealOptionID");
                });

            modelBuilder.Entity("FoodDelivery.Models.DominModels.Meals.FreeSideDishOption", b =>
                {
                    b.HasOne("FoodDelivery.Models.DominModels.Meals.FreeSideDish", "FreeSideDish")
                        .WithMany("SideDishes")
                        .HasForeignKey("FreeSideDishID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDelivery.Models.DominModels.MealOption", "MealOption")
                        .WithMany("FreeSideDishOptions")
                        .HasForeignKey("MealOptionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FreeSideDish");
            ...
            modelBuilder.Entity("FoodDelivery.Models.DominModels.MealOption", b =>
                {
                    b.Navigation("FreeSideDishOptions");

                    b.Navigation("FreeSideDishes");
